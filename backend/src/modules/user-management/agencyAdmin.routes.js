...
router.get('/', authenticateToken, AgencyRoles.requireSuperAgencyAdmin, asyncHandler(agencyAdminService.handleGetAllAgencyAdmins.bind(agencyAdminService)));
...
router.post('/', authenticateToken, AgencyRoles.requireSuperAgencyAdmin, asyncHandler(agencyAdminService.handleCreateAgencyAdmin.bind(agencyAdminService)));
