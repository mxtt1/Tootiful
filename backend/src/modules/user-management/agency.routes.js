...
router.get('/', authenticateToken, AgencyRole.requireSuperAgencyAdmin, asyncHandler(agencyService.handleGetAllAgencyAdmins.bind(agencyService)));
...
router.post('/', authenticateToken, AgencyRole.requireSuperAgencyAdmin, asyncHandler(agencyService.handleCreateAgencyAdmin.bind(agencyService)));
